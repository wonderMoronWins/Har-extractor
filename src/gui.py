...
from src.extractor import extract_images
...
class HarExtractorApp(QWidget):
    ...
    def dropEvent(self, event):
        for url in event.mimeData().urls():
            ...
            if file_path.endswith(".har"):
                ...
                self.info_label.setText(_("Загружен: ") + os.path.basename(file_path))
    ...
    def import_data(self):
        if not hasattr(self, "loaded_file") or not self.loaded_file:
            return
